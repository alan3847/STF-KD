...
class Base_method(l.LightningModule):
    ...
    # =========================
    # Unified interfaces for KD
    # =========================
    def predict(self, batch_x, batch_y=None, **kwargs):
        """Return model prediction using the method's native inference path."""
        return self(batch_x, batch_y, **kwargs)

    def compute_loss(self, batch, **kwargs):
        """Return (native_loss, pred_y) using the method's native training logic."""
        raise NotImplementedError
