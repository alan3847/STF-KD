...
def create_parser():
    ...
    parser.add_argument('--val_batch_size', '-vb', default=16, type=int,
                        help='Validation batch size')
    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--data_root', default='./data')
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=[
                            'bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist',
                            'taxibj', 'human', 'kth', 'kth20', 'kth40', 'kitticaltech',
                            'kinetics', 'kinetics400', 'kinetics600',
                            'weather', 'weather_t2m_5_625', 'weather_mv_4_28_s6_5_625',
                            'weather_mv_4_4_s6_5_625', 'weather_r_5_625',
                            'weather_uv10_5_625', 'weather_tcc_5_625',
                            'weather_t2m_1_40625', 'weather_r_1_40625',
                            'weather_uv10_1_40625', 'weather_tcc_1_40625',
                            'sevir_vis', 'sevir_ir069', 'sevir_ir107', 'sevir_vil'
                        ],
                        help='Dataset name (default: "mmnist")')
    parser.add_argument('--pre_seq_length', default=None, type=int,
                        help='Sequence length before prediction')
    parser.add_argument('--aft_seq_length', default=None, type=int,
                        help='Sequence length after prediction')
    parser.add_argument('--total_length', default=None, type=int,
    ...
    parser.add_argument('--config_file', '-c', default=None, type=str,
                        help='Path to the default config file (used as primary config, usually student config in KD)')
    ...
    # KD parameters
    # ------------------------------------------------------------------
    parser.add_argument('--teacher_method', default=None, type=str,
                        help='Teacher method name for KD, e.g. simvp / phydnet / convlstm')
    parser.add_argument('--student_method', default=None, type=str,
                        help='Student method name for KD, e.g. simvp / phydnet / convlstm')
    parser.add_argument('--teacher_ckpt', default=None, type=str,
                        help='Checkpoint path of teacher model (.ckpt or .pth)')
    parser.add_argument('--student_ckpt', default=None, type=str,
                        help='Optional checkpoint path of student model')
    parser.add_argument('--kd_weight', default=0.5, type=float,
                        help='Weight of KD loss in total loss')
    parser.add_argument('--teacher_config_file', default=None, type=str,
                        help='Optional teacher config file path (reserved for future use)')
    parser.add_argument('--student_config_file', default=None, type=str,
                        help='Optional student config file path (preferred over config_file when provided)')
    parser.add_argument('--teacher_hint_layer', default=None, type=str)
    parser.add_argument('--student_hint_layer', default=None, type=str)
    parser.add_argument('--hint_weight', default=1.0, type=float)
    parser.add_argument('--hint_teacher_channels', default=None, type=int)
    parser.add_argument('--hint_student_channels', default=None, type=int)
    ...
    parser.add_argument('--freq_cutoff', default=0.25, type=float,
                        help='Normalized frequency cutoff in [0, 0.5]')
    parser.add_argument('--freq_loss_type', default='complex', choices=['complex', 'magnitude'],
    ...
    parser.add_argument('--freq_log_mag', type=str2bool, nargs='?', const=True, default=False,
                        help='Use log1p magnitude before frequency loss')
    ...
    # ------------------------------------------------------------------
    parser.add_argument('--epoch', '-e', default=None, type=int,
                        help='End epochs (default: 200)')
    parser.add_argument('--log_step', default=1, type=int,
                        help='Log interval by step')
...
def default_parser():
    default_values = {
        ...
        'teacher_hint_layer': None,
        'student_hint_layer': None,
        'hint_weight': 1.0,
        'hint_teacher_channels': None,
        'hint_student_channels': None,
        'hint_reduce': 'last',
